...
float si7021::readTemp()
{
	...
	float result = (175.72*temp_Code/65536)-46.85;      // 2016-06-25 Changed from 175.25 to 175.72 (Si7021-A20)
	return result;
}
...
void si7021::changeResolution(uint8_t i)
{
	...
	regVal &= 0b01111110;           // 2016-07-03 Fixed bug: 9 bit in original code, should be 8
	switch (i) {
		case 1:
		regVal |= 0b00000001;
		break;
